...
export function ThinkingBlock({ content }: ThinkingBlockProps) {
  ...
  return (
    <div className="rounded-lg border bg-chat-thinking my-3 animate-scale-in overflow-hidden transition-all duration-300">
      <button
      ...
      >
        <Brain className="h-3.5 w-3.5 text-amber-500 group-hover:scale-110 transition-transform duration-200" />
